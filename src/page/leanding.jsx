...
export default function LeandingPage(params) {
  ...
  return (
    <div className="w-full min-h-screen bg-background relative">
      <div className="flex flex-col items-center justify-center h-screen px-20 py-10">
        <div className="flex flex-row items-center justify-between w-full">
          ...
          <div className="flex flex-row items-center justify-center space-x-3 opacity-0">
            <img alt="" src={Logo} />
            <span className="text-2xl font-bold text-white">OakFi</span>
          </div>
        </div>
        <div className="flex flex-col items-center justify-center w-full flex-1">
          ...
          <button className="px-10 py-3 rounded-full bg-cu-green text-background font-bold text-base"  onClick={() => navigate("/value")}>
            Launch App
          </button>
        </div>
      </div>
      <div className="flex flex-col px-20 py-8 space-y-4">
        <div className="flex flex-row w-full items-center justify-center space-x-4 mb-10">
          <span className="text-4xl font-semibold text-white">Oak Fi Optimizer</span>
        ...
        <div className="flex flex-row items-stretch justify-center space-x-6">
          <div className="flex-1 rounded-xl Purple-BG px-10 py-10 flex flex-col space-y-2">
            ...
            <span className="font-semibold py-4 text-xl text-white">Liquidity Pools</span>
            ...
            <div className="flex flex-row py-2 space-x-4 items-center w-[60%]">
              <img alt="" src={Right} className="w-6 h-6" />
              <span className="text-white font-light text-base">
                Earn interest rewards on your LP which is held in Custody by OakFi
              </span>
            </div>
            <div className="flex flex-row py-2 space-x-4 items-center w-[60%]">
              <img alt="" src={Right} className="w-6 h-6" />
              <span className="text-white font-light text-base">
                Oak Fi reinvest your interest by purchasing more of the underlying token pair to
                increase rewards
              </span>
            </div>
            <div className="flex flex-row py-2 space-x-4 items-center w-[60%]">
              <img alt="" src={Right} className="w-6 h-6" />
              <span className="text-white font-light text-base">
                Auto-Compound regularly and automatically repeats the process, saving you time and
                Fees
              </span>
            </div>
          </div>
          <div className="flex-1 rounded-xl Brown-BG px-10 py-10 flex flex-col space-y-2">
            ...
            <span className="font-semibold py-4 text-xl text-white">Oak Reward Pools</span>
            <div className="flex flex-row py-2 space-x-4 items-center w-[60%]">
              <img alt="" src={Right} className="w-6 h-6" />
              <span className="text-white font-light text-base">
                Invest in OAK Token, stake it in Reward Pools for a specific asset
              </span>
            </div>
            <div className="flex flex-row py-2 space-x-4 items-center w-[60%]">
              <img alt="" src={Right} className="w-6 h-6" />
              <span className="text-white font-light text-base">
                Earn shares of the platform’s revenue which is used to purchase the token
              </span>
            </div>
            <div className="flex flex-row py-2 space-x-4 items-center w-[60%]">
              <img alt="" src={Right} className="w-6 h-6" />
              <span className="text-white font-light text-base">
                Oak Fi reinvest your interest and purchase another asset that becomes your reward.
              </span>
            </div>
          </div>
        </div>
      </div>
      <div className="flex flex-col items-center justify-center py-40 space-y-8 w-full">
        ...
        <div className="flex flex-row items-center justify-center space-x-4 w-full flex-wrap max-w-7xl">
          ...
          <div className="space-x-2 max-w-[186px] w-full py-4 my-2 rounded-md shadow-md bg-radian-purple-200 flex flex-row items-center justify-center">
            <img alt="" src={Litecoin} className="w-12 h-12 object-scale-down" />
      ...
      <div className="flex flex-col items-center justify-center px-20 py-8 space-y-4">
        <div className="flex flex-col w-full items-center justify-center space-y-6 mb-4">
          <span className="text-4xl font-semibold text-white">OAK Token</span>
          <span className="text-xl font-medium text-white text-center">
            <span className="text-cu-green">$OAK</span> is the native revenue-share and governance
            token for our protocol.
          </span>
        </div>
        <div className="w-full max-w-5xl flex flex-row items-stretch justify-center space-x-4">
          <div className="flex-1 flex flex-col items-center justify-center space-y-4">
            <div className="Dark-Green-BG p-4 w-full flex flex-col space-y-4 shadow-lg">
              <span className="text-base text-white font-semibold">OAK Hodl</span>
              <span className="text-base text-white text-opacity-60">
                Oak holders share in our revenue by staking their OAK in OAK Hodl vaults.
              </span>
              <div className="flex flex-row space-x-2 items-center">
                <LaunchIcon className="text-cu-green" />
                <span className="text-cu-green text-base font-bold">Earn OAK</span>
              </div>
            </div>
            <div className="Dark-Green-BG p-4 w-full flex flex-col space-y-4 shadow-lg">
              <span className="text-base text-white font-semibold">OAK Reward Pools</span>
              <span className="text-base text-white text-opacity-60">
                Staking OAK in OAK Reward Pool earns you specific tokens with the platform’s
                earnings.
              </span>
              <div className="flex flex-row space-x-2 items-center">
                <LaunchIcon className="text-cu-green" />
            ...
            <div className="Dark-Green-BG p-4 w-full flex flex-col space-y-4 shadow-lg">
              <span className="text-base text-white font-semibold">Governance</span>
              <span className="text-base text-white text-opacity-60">
                Our snapshot governance mechanism will give OAK holders a voting power in Oak Fi’s
                Dao soon.
              </span>
              <div className="flex flex-row space-x-2 items-center">
                <LaunchIcon className="text-cu-green" />
          ...
          <div className="flex-1 Green-BG relative flex flex-col justify-between p-10">
            <img alt="" src={Oakfi_bg} className="w-full h-full bottom-0 right-0 absolute" />
            <div className="flex flex-col space-y-2">
              <span className="text-2xl text-white font-semibold">Fixed Max Supply</span>
              <span className="text-base text-white text-opacity-60 w-[80%]">
                A Fixed Maximum supply of 50,000 OAK tokens acts as a control against token
                inflation.
              </span>
            </div>
            <div className="flex flex-row space-x-2 items-center">
              <LaunchIcon className="text-cu-green" />
              <span className="text-cu-green text-base font-bold">Learn more</span>
            </div>
          </div>
        </div>
      </div>
      <div className="flex flex-row items-center justify-center pt-20 space-x-4">
        <a
          href="https://oak-fi.gitbook.io/oak-fi/"
          target="_"
          className="text-white text-lg font-semibold"
        >
          Docs
        </a>
        <a href="https://medium.com/@oakfi" target="_" className="text-white text-lg font-semibold">
          Blog
        </a>
        <a
          href="https://discord.com/invite/CR9me6dYnD"
          target="_"
          className="text-white text-lg font-semibold"
        >
          MediaKit
